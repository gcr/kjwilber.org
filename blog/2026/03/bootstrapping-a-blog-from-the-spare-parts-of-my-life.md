---
title: "Bootstrapping a blog from the spare parts of my life"
date: 2026-03-16
tags:
  - half-baked
ail: 0
...
Blogging for me was an exercise in distraction. From time to time, the activation energy of some exciting new platform would draw me to start a blog there with ambitions of using it forever, but each attempt was always about the novelty of the platform rather than the substance of the writing. Curiosity left me wandering through various writing initiatives, quickly abandoning each as interest waned.  My [first foray of this 'blogging' concept from 2013](https://web.archive.org/web/20190107154522/http://sneakygcr.net/making-old-crt-style-television-screens-with-racket-and-imagesflomap.html) lasted about a post and a half, and [my old tumblr blog from 2013](https://ghostynewt.tumblr.com/) quickly became solely devoted to the tumblr plugin for Emacs that I used to author it.  Let's not even mention [my Medium account](https://medium.com/@mwilber) (yikes),  which features one transcript of a post-election conference from the NAACP and one trip report from meeting a sleep paralysis demon and precisely nothing else.
...
- "TODO compose email to boris re: internship."
- "CANCELED: date with [redacted]."
- "Outline for pixel cafe talk."
...
- **Sketches** and projects, aka. "look Mom, I made something!"
- **Quotes** from other people that I find interesting
- **TILs** and HOWTO content, inspired by Julia Evans and Simon Willison
- **Blogmarks** to interesting articles, perhaps local copies of great sci-fi stories, and other references; also inspired by Simon Willison
- **Half-baked thoughts** and diary-style content that may only be relevant to my own experience

Someday I expect to migrate this to kdb, my spiritual successor to TiddlyWiki, but that will take time.

### Inspirations

- [Gwern](https://gwern.net/)'s meticulousness
- [Julia Evans'](https://jvns.ca/) earnestness
- [Simon Willison](https://simonwillison.net/)'s curiosity and format
- [Andy Matuschak](https://notes.andymatuschak.org/Evergreen_notes)'s ideals and philosophy of ravenous learning
- [qntm](https://qntm.org/)'s imagination
- Matthew Stover's prose in [his 2005 novelization of Star Wars Episode III: Revenge of the Sith](https://www.goodreads.com/book/show/13135469), which was the last time I read prose that absolutely knocked my socks off and I'm only mildly ashamed of this
- [Halimede](https://substack.com/@halimedemf)'s critical eye and highly structured thinking
...
1. "Bookmarks," an ancient technique where you *remember to occasionally visit my site and read the new content*.
    - Here's a [video](https://youtu.be/D-MWmeJJJY8?t=1024#t=1024) where bookmark master and critically acclaimed film director Freddie Wong explains this technique.
3. RSS feed
...
This is an exercise in developing my internal appreciation and taste for things that I like.

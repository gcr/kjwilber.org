...
\item \textbf{Languages and Libraries:}
  ...
  with strong POSIX/CLI proficiency. %Reasonably familiar with Lua/Torch7,
...
%See the ``BAM: Behance Artistic Media'' publication below.
\vspace{-5pt}
\end{itemize}
\\
...
\begin{itemize}
\item Conducted computer vision research on %on many areas of computer vision including
 perceptual similarity, %large-scale

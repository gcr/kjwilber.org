...
== Open-source contributions
  ...
  - My #link("https://github.com/gcr")[GitHub profile] has 196 followers.
...
/ Web: Flask, FastAPI, NodeJS, Vue, React
/ Sysadmin: Debian/Ubuntu server clusters, Ansible, Docker, AWS EC2, GCP, on-prem
...
#let experience = (
  (
    ...
    description: [
      ...
      - Built "Krnel MI Guardrails," a comment safety filter achieving $25 times$ fewer false alarms than LlamaGuard and $33%$ lower latency. See #link("https://github.com/krnel-ai/krnel-graph-guardrails")[code], #link("https://krnel.ai/blog/2025-06-09-guardrail-comparison/")[blog post]
      - Designed and implemented #link("https://github.com/krnel-ai/krnel-graph#readme")[`krnel-graph`], a library for building LLM mind-reading tools
        - Krnel-graph is widely used within all of the company's research projects
      - Led the open-source process for krnel-graph, including drafting documentation and shepherding research contributions $arrow$ 22 stars, $approx$200 downloads/month
    ...
    - Co-led development of _Debug Server v2_, an embedding-model inspection platform used by 4+ Google teams (Play Ads, RankEmbed, Intent Mining, LocalEmbed) for debugging large-scale retrieval systems.
    ...
    - Co-led creation of #link("https://research.google/blog/sanpo-a-scene-understanding-accessibility-navigation-pathfinding-obstacle-avoidance-dataset/")[SANPO], a large-scale egocentric scene understanding dataset used for depth estimation research, accessibility products, and ARCore models.
      - Our dataset has 10 citations in research papers, $approx$50 downloads/month, used by 3+ teams across Google for research and product development
    ...
    description: [
      ...
      - I own our PDF processing pipeline used in conference proceedings construction.
